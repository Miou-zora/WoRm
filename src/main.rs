...
use crate::worm_path::{debug_draw_path, setup_head, update_head, update_worm, update_worm_parts};
...
fn main() {
    App::new()
        ...
        .add_systems(Update, ((update_head, update_worm, update_worm_parts).chain(),
                              debug_draw_path)) // Debug
        .run();
}
